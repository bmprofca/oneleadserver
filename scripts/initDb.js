...
CREATE TABLE IF NOT EXISTS leads (
  ...
  status ENUM('new', 'contacted', 'qualified', 'proposal', 'negotiation', 'won', 'lost', 'not_interested') NOT NULL DEFAULT 'new',
...
CREATE TABLE IF NOT EXISTS reminders (
  ...
  CONSTRAINT fk_reminders_product FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS appointments (
  ...
  CONSTRAINT fk_appointments_product FOREIGN KEY (product_id) REFERENCES products(id) ON DELETE SET NULL,
